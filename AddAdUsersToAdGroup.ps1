...
$logFile = "E:\SysteembeheerScripts\Log\AddUsersToAdGroups-"+(Get-Date -UFormat "%Y%m%d%H%M%S")+".log"
$StartDateTime = (Get-Date -UFormat "%Y-%m-%d %H:%M:%S")
# Voeg de koptekst toe aan het logbestand.
Add-Content $logFile -value "
************************************************************************************************
Het volgende script is gestart: E:\SysteembeheerScripts\adScripts\AddUsersToAdGroup.ps1
